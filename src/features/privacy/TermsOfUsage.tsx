...
- Catálogo e gestão de produtos e estoque.
- Criação e acompanhamento de pedidos e vendas.
- Ferramentas de agendamento e criação de conteúdo para mídias sociais.
Você reconhece e concorda que a Plataforma é destinada a auxiliar na gestão de suas atividades comerciais e que você é o único responsável por todas as transações, interações com clientes e conformidade legal de seu próprio negócio.
### 3. Cadastro e Segurança da Conta
- **3.1. Elegibilidade**: Ao se cadastrar, você declara que é maior de idade e legalmente capaz de celebrar contratos vinculativos. O uso da Plataforma é restrito a contas comerciais ou profissionais.
- **3.2. Informações da Conta**: Você se compromete a fornecer informações de registro precisas, completas e atualizadas. Você é o único responsável por manter a confidencialidade de sua senha e por todas as atividades que ocorram em sua conta.
- **3.3. Notificação**: Você deve nos notificar imediatamente sobre qualquer uso não autorizado de sua conta ou qualquer outra violação de segurança.
### 4. Integração com a API do Instagram
- **4.1. Autorização**: A Plataforma permite que você conecte sua(s) conta(s) do Instagram (que devem ser Contas Comerciais ou de Criador) para criar e publicar conteúdo em múltiplos perfis. Ao conectar sua conta, você nos autoriza a acessar e utilizar os dados da sua conta do Instagram estritamente para os fins de publicação e gerenciamento de conteúdo, conforme detalhado em nossa Política de Privacidade.
- **4.2. Conformidade com a Meta**: Você reconhece e concorda que, ao utilizar a funcionalidade de integração com o Instagram, você deve cumprir integralmente os Termos da Plataforma da Meta e todas as políticas aplicáveis (incluindo, mas não se limitando, às políticas de privacidade e uso de dados). Você é o único responsável por garantir que o conteúdo que você publica através da Plataforma esteja em conformidade com as regras do Instagram.
- **4.3. Permissões**: Você nos concede todas as permissões necessárias para interagir com a API do Instagram em seu nome, incluindo, mas não se limitando, às permissões de publicação de conteúdo (instagram_business_content_publish).
- **4.4. Responsabilidade**: Nós não nos responsabilizamos por quaisquer suspensões, restrições ou penalidades aplicadas à sua conta do Instagram pela Meta devido ao uso indevido da API ou violação das políticas do Instagram.
### 5. Conteúdo do Usuário e Conduta
- **5.1. Conteúdo**: Você é o único responsável por todo o conteúdo (textos, imagens, vídeos, dados de clientes e produtos) que você insere, armazena ou publica através da Plataforma (“Conteúdo do Usuário”).
...
- **7.2. Limitação de Responsabilidade**: Na extensão máxima permitida pela lei aplicável, em nenhuma circunstância a Empresa será responsável por quaisquer danos indiretos, incidentais, especiais, consequenciais ou punitivos, incluindo, mas não se limitando a, perda de lucros, dados ou uso, resultantes do seu acesso ou uso da Plataforma.
### 8. Rescisão
